...
import styles from '../styles/MyServiceCardStyles'

export default class MyServiceCard extends Component {
  constructor(props) {
    super(props)
    this.state = {
      ...
      >
        <View>
          <View style={styles.imageContainer}>
            <Image style={styles.image} source={{ uri: businessData.Pictures.Favorite }} />
          </View>
